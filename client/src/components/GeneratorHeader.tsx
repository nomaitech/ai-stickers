...
const GeneratorHeader = () => {
    return (
        <Section>
            <Flex mt={8} flexDirection="column" align="left">
                ...
                <Text mt={8} fontSize="xl" color="fg.muted">Upload any photo to generate a sticker ready to use in chat apps, memes, or merch.</Text>
            </Flex>
        </Section>
    )
}
