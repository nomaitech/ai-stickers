...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_images_original_img_url'), 'images', ['original_img_url'], unique=False)
    op.create_index(op.f('ix_images_generated_img_url'), 'images', ['generated_img_url'], unique=False)
...
def downgrade() -> None:
    ...
    op.add_column('images', sa.Column('generated_img', sa.LargeBinary(), autoincrement=False, nullable=False))
    op.add_column('images', sa.Column('original_img', sa.LargeBinary(), autoincrement=False, nullable=False))
